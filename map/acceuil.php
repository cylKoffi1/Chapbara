...
<head>
    ...
    <script defer
            src="https://maps.googleapis.com/maps/api/js?libraries=places&language=<?= $_SESSION['lang'] ?>&key=AIzaSyBZqyYBihfsNPxj8FbbQ9D2hEDankJm66w"
...
<div class="container">
        ...
        <div class="col-sm-4">
            ...
            <form id="distance_form">
                ...
                <div class="form-group"><label><?= $lang['origin'] ?>: </label>
                    ...
                    <input id="origin" name="origin" required="required" type="hidden"/>
                    <a class="form-control" onclick="getCurrentPosition()">Votre position</a>
                </div>
        ...
        <div class="col-sm-4">
         <div id="map" style="height: 300px; width: 400px" ></div>
          ...
          <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBZqyYBihfsNPxj8FbbQ9D2hEDankJm66w&callback=loadMap">
</script>
            <!-- result -->
        <div class="col-sm-4">
